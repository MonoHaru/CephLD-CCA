...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        for phase in uu:
            ...
            savepath1 = r'E:\X-Ray\model\Original_SE_block_All_U_Net_003_3\Network_{}_E_{}.pth'
            savepath2 = r'E:\X-Ray\model\Original_SE_block_All_U_Net_003_3\Best_Network_{}_E_{}.pth'
    ...
    plt.title('Original_SE_block_All_U_Net_003_3')
    plt.xlabel('epoch')
    plt.ylabel('loss')
