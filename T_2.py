...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        for phase in uu:
            ...
            savepath1 = r'E:\X-Ray\model\BaseLine_Train_Dataset_002_2\Network_{}_E_{}.pth'
            savepath2 = r'E:\X-Ray\model\BaseLine_Train_Dataset_002_2\Best_Network_{}_E_{}.pth'
    ...
    plt.title('BaseLine_Train_Dataset_002_2')
    plt.xlabel('epoch')
    plt.ylabel('loss')
