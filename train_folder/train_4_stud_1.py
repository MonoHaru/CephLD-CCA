...
H=400; W=320;
dataloaders = {
    'train': DataLoader(dataload(path='data/train_30', H=H, W=W,pow_n=8, aug=True) , batch_size=batch_size, shuffle=True, num_workers=8),
...
model=network.U_Net_std_1(1, num_class).to(device)
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        for phase in uu:
            ...
            savepath = r'E:\X-Ray\model\train_stud_1\Network_{}_E_{}.pth'
