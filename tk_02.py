...
dataloaders = {
    'train': DataLoader(dataload(path='data/train', H=H, W=W, pow_n=8, aug=False), batch_size=batch_size, shuffle=True,
                        num_workers=8),
...
if __name__ == '__main__':
    ...
    model = network.my_Net_02(1, num_class).to(device)
    print(model)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in uu:
            ...
            savepath1 = r'E:\X-Ray\model\Cartesian_Squeeze_and_Excitation_U_Net_004\Network_{}_E_{}.pth'
            savepath2 = r'E:\X-Ray\model\Cartesian_Squeeze_and_Excitation_U_Net_004\Best_Network_{}_E_{}.pth'
