...
H=800; W=640;
dataloaders = {
    'train': DataLoader(dataload(path='data/train_15', H=H, W=W,pow_n=8, aug=True) , batch_size=batch_size, shuffle=True, num_workers=10),
    'val': DataLoader(dataload(path='data/test2', H=H, W=W, pow_n=8, aug=False), batch_size=batch_size, shuffle=False, num_workers=10)
}
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        for phase in uu:
            ...
            savepath = r'E:\X-Ray\model\SE_T_2_test2\Network_{}_E_{}.pth'
