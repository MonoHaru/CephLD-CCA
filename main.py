...
H=200; W=160;
dataloaders = {
    'train': DataLoader(dataload(path='data/train', H=H, W=W, pow_n=6, aug=True) , batch_size=batch_size, shuffle=True, num_workers=6),
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        for phase in uu:
            ...
            savepath = 'model/21_10_06/Network_{}_E_{}.pth'
