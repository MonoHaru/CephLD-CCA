...
if __name__ == '__main__':
    ...
    scheduler = CosineAnnealingWarmUpRestarts(optimizer=optimizer, T_0=100, T_mult=2, eta_max=1e-4, T_up=1, gamma=0.3)
    print("****************************GPU : ", device)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in uu:
            ...
            savepath1 = r'E:\X-Ray\model\Original_SE_block_Decoding_U_Net_004_1\Network_{}_E_{}.pth'
            savepath2 = r'E:\X-Ray\model\Original_SE_block_Decoding_U_Net_004_1\Best_Network_{}_E_{}.pth'
    ...
    plt.title('Original_SE_block_Decoding_U_Net_004_1')
    plt.xlabel('epoch')
    plt.ylabel('loss')
