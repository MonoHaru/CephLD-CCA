...
H=800; W=640;
dataloaders = {
    'train': DataLoader(dataload(path='data/train_15', H=H, W=W,pow_n=6, aug=True) , batch_size=batch_size, shuffle=True, num_workers=6),
    'val': DataLoader(dataload(path='data/test1', H=H, W=W, pow_n=6, aug=False), batch_size=batch_size, shuffle=False, num_workers=6)
}
...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load('model/21_10_06_1/Network_0.0017244925256818533_E_519.pth',map_location=device_txt))
    ...
    for epoch in range(num_epochs):
        ...
        for phase in uu:
            ...
            savepath = 'model/21_10_06_1/Network_{}_E_{}.pth'
